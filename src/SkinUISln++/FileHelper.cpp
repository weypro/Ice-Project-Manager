...
BOOL CFileHelper::MakeSureFolderExist(const tstring& strPath)
{
	if (::SHCreateDirectoryEx(NULL, strPath.c_str(), NULL) != ERROR_SUCCESS && ::GetLastError() != ERROR_ALREADY_EXISTS)
	{
		return FALSE;
	}
